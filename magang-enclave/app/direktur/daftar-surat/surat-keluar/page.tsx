...
import Sidebar from "@/app/components/sidebar-direktur";
...
export default function SuratMasukPage() {
  ...
  const tabs = [
    { id: "surat-masuk", label: "Surat Masuk", path: "/direktur/daftar-surat/surat-masuk" },
    { id: "surat-keluar", label: "Surat Keluar", path: "/direktur/daftar-surat/surat-keluar" },
    { id: "memo", label: "Memo", path: "/direktur/daftar-surat/memo" },
    { id: "notulensi", label: "Notulensi", path: "/direktur/daftar-surat/notulensi" },
  ];
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredData.length > 0 ? filteredData.map((row, index) => (
                    <tr
                      key={index}
                      onClick={() => router.push(`/direktur/surat-keluar?id=${row.no}`)}
