...
export default function SuratMasukPage() {
  ...
  const tabs = [
    { id: "surat-masuk", label: "Surat Masuk", path: "/direktur/arsip/surat-masuk" },
    { id: "surat-keluar", label: "Surat Keluar", path: "/direktur/arsip/surat-keluar" },
    { id: "memo", label: "Memo", path: "/direktur/arsip/memo" },
    { id: "notulensi", label: "Notulensi", path: "/direktur/arsip/notulensi" },
  ];
