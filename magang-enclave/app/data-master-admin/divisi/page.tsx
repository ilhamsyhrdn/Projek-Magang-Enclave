...
export default function DivisiPage() {
  ...
  const [tableData, setTableData] = useState([
    { namaDivisi: "Keuangan", kodeDivisi: "A", status: true },
    { namaDivisi: "Pengambangan usaha", kodeDivisi: "B", status: true },
    { namaDivisi: "Public Relation", kodeDivisi: "C", status: true },
  ]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsEditMode(false);
    setEditIndex(null);
    setFormData({ namaDivisi: "", kodeDivisi: "" });
  };

  const handleEdit = (index: number) => {
    setFormData({
      namaDivisi: tableData[index].namaDivisi,
      kodeDivisi: tableData[index].kodeDivisi
    });
    setEditIndex(index);
    setIsEditMode(true);
    setIsModalOpen(true);
