...
interface SidebarAdkProps {
  isOpen: boolean;
  onToggle: () => void;
}

export default function SidebarAdk({
  isOpen,
  onToggle,
}: SidebarAdkProps) {
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    const typeRoutes: { [key: string]: string } = {
      'surat-keluar': `/adk/surat-keluar?id=${notification.documentId}`,
      'surat-masuk': `/adk/surat-masuk?id=${notification.documentId}`,
      'memo': `/adk/memo?id=${notification.documentId}`,
      'notulensi': `/adk/notulensi?id=${notification.documentId}`,
    };
        ...
        <nav className="px-4 space-y-1 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          <Link
            ...
            className={`
              ...
              ${pathname === "/adk/beranda" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Surat Masuk */}
          <Link
            href="/adk/surat-masuk"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/adk/surat-masuk" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Surat Keluar */}
          <Link
            href="/adk/surat-keluar"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/adk/surat-keluar" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/adk/memo" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/adk/notulensi" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Daftar Surat */}
          <Link
            href="/adk/daftar-surat/surat-masuk"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname.startsWith("/adk/daftar-surat") ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname.startsWith("/adk/arsip") ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
