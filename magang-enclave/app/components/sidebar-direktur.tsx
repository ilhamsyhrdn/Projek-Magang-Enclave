...
interface SidebarDirekturProps {
  isOpen: boolean;
  onToggle: () => void;
}

export default function SidebarDirektur({
  isOpen,
  onToggle,
}: SidebarDirekturProps) {
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    const typeRoutes: { [key: string]: string } = {
      'surat-keluar': `/direktur/surat-keluar?id=${notification.documentId}`,
      'surat-masuk': `/direktur/surat-masuk?id=${notification.documentId}`,
      'memo': `/direktur/memo?id=${notification.documentId}`,
      'notulensi': `/direktur/notulensi?id=${notification.documentId}`,
    };
    ...
    <>
      ...
      >
        ...
        <nav className="px-4 space-y-1 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          {/* Surat Masuk */}
          <Link
            href="/direktur/surat-masuk"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/direktur/surat-masuk" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Surat Keluar */}
          <Link
            href="/direktur/surat-keluar"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/direktur/surat-keluar" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/direktur/memo" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Notulensi */}
          <Link
            href="/direktur/notulensi"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/direktur/notulensi" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Daftar Surat */}
          <Link
            href="/direktur/daftar-surat/surat-masuk"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname.startsWith("/direktur/daftar-surat") ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname.startsWith("/direktur/arsip") ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
