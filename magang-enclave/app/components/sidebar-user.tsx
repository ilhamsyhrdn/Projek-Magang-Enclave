...
export default function SidebarUser({
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    const typeRoutes: { [key: string]: string } = {
      'surat-keluar': `/user/surat-keluar?id=${notification.documentId}`,
      'surat-masuk': `/user/surat-masuk?id=${notification.documentId}`,
      'memo': `/user/memo?id=${notification.documentId}`,
      'notulensi': `/user/notulensi?id=${notification.documentId}`,
    };
        ...
        <nav className="px-4 space-y-1 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          <Link
            ...
            className={`
              ...
              ${pathname === "/user/beranda" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Surat Masuk */}
          <Link
            href="/user/surat-masuk"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/user/surat-masuk" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Surat Keluar */}
          <Link
            href="/user/surat-keluar"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/user/surat-keluar" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/user/memo" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname === "/user/notulensi" ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          {/* Daftar Surat */}
          <Link
            href="/user/daftar-surat"
            onClick={() => {
              if (window.innerWidth < 1024) onToggle();
            }}
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname.startsWith("/user/daftar-surat") ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
          ...
          <Link
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-3 rounded-[10px] transition-colors
              ${pathname.startsWith("/user/arsip") ? "bg-[#bcdff6]" : "hover:bg-gray-50"}
            `}
          >
