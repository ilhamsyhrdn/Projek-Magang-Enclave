...
export default function ArsipSuratMasukPage() {
  ...
  const tabs = [
    { id: "surat-masuk", label: "Surat Masuk", path: "/arsip-admin/suratMasuk" },
    { id: "surat-keluar", label: "Surat Keluar", path: "/arsip-admin/suratKeluar" },
    { id: "memo", label: "Memo", path: "/arsip-admin/memo" },
    { id: "notulensi", label: "Notulensi", path: "/arsip-admin/notulensi" },
  ];

  const allData: SuratMasukData[] = [
    { no: 1, namaSurat: "Surat Kerjasama", nomorSurat: "01/SM/11/2025", pengirim: "PT. Mitra Sejahtera", penerima: "Departemen Hubungan Eksternal", tanggal: "2025-11-15" },
    { no: 2, namaSurat: "Surat Permohonan", nomorSurat: "02/SM/11/2025", pengirim: "Universitas Indonesia", penerima: "Departemen Kelimuan", tanggal: "2025-11-14" },
    { no: 3, namaSurat: "Surat Peminjaman Dana", nomorSurat: "03/SM/10/2025", pengirim: "BEM FT", penerima: "Departemen Keuangan", tanggal: "2025-10-20" },
    { no: 4, namaSurat: "Surat Undangan", nomorSurat: "04/SM/10/2025", pengirim: "Himpunan Mahasiswa", penerima: "Departemen Hubungan Internal", tanggal: "2025-10-18" },
    { no: 5, namaSurat: "Surat Pemberitahuan", nomorSurat: "05/SM/09/2025", pengirim: "Fakultas Teknik", penerima: "Departemen Media Informasi", tanggal: "2025-09-25" },
    { no: 6, namaSurat: "Surat Izin Kegiatan", nomorSurat: "06/SM/09/2025", pengirim: "Dekanat", penerima: "Departemen Pengembangan Organisasi", tanggal: "2025-09-22" },
    { no: 7, namaSurat: "Surat Sponsorship", nomorSurat: "07/SM/08/2025", pengirim: "PT. Tech Innovation", penerima: "Departemen Kewirausahaan", tanggal: "2025-08-10" },
    { no: 8, namaSurat: "Surat Kerjasama Akademik", nomorSurat: "08/SM/08/2025", pengirim: "Institut Teknologi", penerima: "Departemen Keprofesian", tanggal: "2025-08-05" },
    { no: 9, namaSurat: "Surat Permohonan Data", nomorSurat: "09/SM/07/2025", pengirim: "Lembaga Penelitian", penerima: "Dept. Pengembangan Teknologi & Informasi", tanggal: "2025-07-15" },
    { no: 10, namaSurat: "Surat Kegiatan Sosial", nomorSurat: "10/SM/07/2025", pengirim: "PMI Cabang", penerima: "Departemen Sosial", tanggal: "2025-07-10" },
  ];
  ...
  const handleDownload = (row: SuratMasukData) => {
