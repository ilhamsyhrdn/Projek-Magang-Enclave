...
export default function DashboardSuperAdmin() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <div className="flex-1 lg:ml-[269px]">
        ...
        <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
          ...
          <h1 className="font-['Poppins'] font-semibold text-lg text-gray-900">
            Akun Terdaftar
          </h1>
        ...
        <div className="hidden lg:block sticky top-4 left-4 z-30">
          <button
            onClick={() => setSidebarOpen(!sidebarOpen)}
            className="fixed top-4 left-4 p-3 bg-white hover:bg-gray-100 rounded-xl shadow-md transition-colors"
          >
            <Menu className="w-6 h-6 text-gray-700" />
          </button>
        </div>
        ...
        <div className="p-8">
          <div className="max-w-7xl mx-auto">
            {/* Header Section */}
            <div className="mb-8">
              <h1 className="font-['Poppins'] font-bold text-3xl text-gray-900 mb-6 hidden lg:block">
                Akun Terdaftar
              </h1>
