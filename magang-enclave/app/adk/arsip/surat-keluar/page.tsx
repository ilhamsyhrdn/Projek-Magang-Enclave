...
export default function SuratMasukPage() {
  ...
  const tabs = [
    { id: "surat-masuk", label: "Surat Masuk", path: "/adk/arsip/surat-masuk" },
    { id: "surat-keluar", label: "Surat Keluar", path: "/adk/arsip/surat-keluar" },
    { id: "memo", label: "Memo", path: "/adk/arsip/memo" },
    { id: "notulensi", label: "Notulensi", path: "/adk/arsip/notulensi" },
  ];
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredData.length > 0 ? filteredData.map((row, index) => (
                    <tr
                      key={index}
                      onClick={() => router.push(`/adk/surat-keluar?id=${row.no}`)}
