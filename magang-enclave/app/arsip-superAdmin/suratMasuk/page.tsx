...
export default function ArsipSuratMasukSuperAdminPage() {
  ...
  const allData: SuratMasukData[] = [
    { no: 1, namaSurat: "Surat Undangan Rapat", nomorSurat: "001/SM/11/2025", pengirim: "Dekan Fakultas Teknik", penerima: "BEM FT", tanggal: "2025-11-15" },
    { no: 2, namaSurat: "Surat Permohonan Kerjasama", nomorSurat: "002/SM/11/2025", pengirim: "PT. Tech Indonesia", penerima: "Dept. Kewirausahaan", tanggal: "2025-11-12" },
    { no: 3, namaSurat: "Surat Pemberitahuan", nomorSurat: "003/SM/10/2025", pengirim: "Universitas", penerima: "Ketua BEM", tanggal: "2025-10-22" },
    { no: 4, namaSurat: "Surat Izin Kegiatan", nomorSurat: "004/SM/10/2025", pengirim: "Rektorat", penerima: "BEM FT", tanggal: "2025-10-18" },
    { no: 5, namaSurat: "Surat Sponsorship", nomorSurat: "005/SM/09/2025", pengirim: "PT. Digital Solutions", penerima: "Dept. Kewirausahaan", tanggal: "2025-09-20" },
    { no: 6, namaSurat: "Surat Undangan Seminar", nomorSurat: "006/SM/09/2025", pengirim: "HMIF", penerima: "Seluruh Mahasiswa", tanggal: "2025-09-15" },
    { no: 7, namaSurat: "Surat Permohonan Dana", nomorSurat: "007/SM/08/2025", pengirim: "Himpunan Mahasiswa", penerima: "Dept. Keuangan", tanggal: "2025-08-10" },
    { no: 8, namaSurat: "Surat Kerjasama Event", nomorSurat: "008/SM/08/2025", pengirim: "Komunitas Teknologi", penerima: "Dept. Media", tanggal: "2025-08-05" },
    { no: 9, namaSurat: "Surat Pemberitahuan Lomba", nomorSurat: "009/SM/07/2025", pengirim: "Panitia Lomba", penerima: "Mahasiswa FT", tanggal: "2025-07-20" },
    { no: 10, namaSurat: "Surat Undangan Workshop", nomorSurat: "010/SM/07/2025", pengirim: "Dept. Keilmuan", penerima: "Seluruh Anggota", tanggal: "2025-07-12" },
  ];
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-[#205d7d]">
                    ...
                    <th className="font-['Poppins'] font-medium text-sm py-4 px-4 text-left text-white min-w-[200px]">Nama Surat</th>
                    <th className="font-['Poppins'] font-medium text-sm py-4 px-4 text-left text-white min-w-[140px]">Nomor Surat</th>
                    <th className="font-['Poppins'] font-medium text-sm py-4 px-4 text-left text-white min-w-[200px]">Pengirim</th>
