...
export default function SuratMasukPage() {
  ...
  const tabs = [
    { id: "surat-masuk", label: "Surat Masuk", path: "/user/arsip/surat-masuk" },
    { id: "surat-keluar", label: "Surat Keluar", path: "/user/arsip/surat-keluar" },
    { id: "memo", label: "Memo", path: "/user/arsip/memo" },
    { id: "notulensi", label: "Notulensi", path: "/user/arsip/notulensi" },
  ];
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredData.length > 0 ? filteredData.map((row, index) => (
                    <tr
                      key={index}
                      onClick={() => router.push(`/user/surat-masuk?id=${row.no}`)}
